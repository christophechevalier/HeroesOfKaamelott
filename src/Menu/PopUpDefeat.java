...
public class PopUpDefeat extends JFrame implements ActionListener {

	private static final long serialVersionUID = 1L;
	private JPanel panelMain, panelDefeat;
	private JButton menuReturn;

	public Boolean reponseMenuReturn1 = null;
	String ligne1="\" Vous êtes un looser !\"";
	...
	public PopUpDefeat()  {
		...
		panelDefeat.setOpaque(true);
		panelDefeat.setFont(policeTexte);
		...
		// buton win
		menuReturn = new JButton("You Lose !", new ImageIcon("images/seli.png" ));
		...
		// ajout du bouton win
		panelDefeat.add(menuReturn);
		panelMain.add(panelDefeat);	
	}

	/*********************************
	 * *******************************
	 * TODO EVENEMENT BOUTON MENU RETURN 1
	 * *******************************
	 *//******************************/	
	...
	public Boolean getReponseMenuReturn() {
		...
		return this.reponseMenuReturn1;
	}
}
